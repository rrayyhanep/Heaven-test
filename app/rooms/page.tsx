...
const rooms = [
  {
    ...
    slug: 'living-room',
    features: ['Comfortable Seating', 'Stylish Coffee Tables', 'Accent Chairs', 'Entertainment Centers'],
  },
  {
    id: 2,
    name: 'Dining Room',
    ...
    slug: 'dining-room',
    features: ['Dining Tables', 'Dining Chairs', 'Buffets & Sideboards', 'Bar Furniture'],
  },
  {
    id: 3,
    name: 'Bedroom',
    ...
    slug: 'bedroom',
    features: ['Bed Frames', 'Dressers', 'Nightstands', 'Wardrobes'],
  },
  {
    id: 4,
    name: 'Office',
    ...
    slug: 'office',
    features: ['Desks', 'Office Chairs', 'Storage Solutions', 'Conference Tables'],
  },
]
            ...
            {rooms.map((room, index) => (
              ...
              >
                <div
                  ...
                  className="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer h-full"
                >
                  <div className="relative h-64 bg-gradient-to-br from-heaven-teal-light/20 to-heaven-blue-light/20 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-heaven-teal-dark/60 to-heaven-teal/60 group-hover:from-heaven-teal-dark/70 group-hover:to-heaven-teal/70 transition-all duration-300 flex items-center justify-center">
                      <div className="text-center text-white z-10">
                        <div className="w-20 h-20 mx-auto mb-4 rounded-lg bg-white/20 flex items-center justify-center backdrop-blur-sm">
                          <svg
                            className="w-10 h-10"
                            fill="none"
                            stroke="currentColor"
                  ...
                  <div className="p-6">
                    <p className="text-heaven-teal-light mb-4">{room.description}</p>
                    <div className="flex flex-wrap gap-2">
                      {room.features.map((feature, idx) => (
                        <span
                          key={idx}
                          className="px-3 py-1 bg-heaven-blue-light/20 text-heaven-teal-dark text-sm rounded-full"
                        >
                          {feature}
                        </span>
                      ))}
