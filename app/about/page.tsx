    ...
    <div className="pt-20 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-gradient-to-br from-heaven-blue-light/10 to-heaven-teal-light/10 rounded-lg p-8 mb-8">
            <h2 className="text-3xl font-semibold text-heaven-teal-dark mb-4">
              Our Story
            </h2>
            <p className="text-heaven-teal-light leading-relaxed mb-4">
            ...
            <p className="text-heaven-teal-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-heaven-blue-light/20">
              <h3 className="text-2xl font-semibold text-heaven-teal-dark mb-3">
                Our Mission
              </h3>
          ...
          <div className="bg-heaven-teal-dark text-white rounded-lg p-8">
