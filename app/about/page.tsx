    ...
    <div className="pt-20 pb-20 bg-warm-gray-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
            <SpotlightCard className="bg-gradient-to-br from-heaven-blue-light/20 to-heaven-teal-light/20 backdrop-blur-sm rounded-lg p-8 mb-8">
          ...
          <SpotlightCard spotlightColor="rgba(125, 211, 240, 0.2)" className="bg-heaven-teal-dark text-white rounded-lg p-8">
