...
export const products: Product[] = [
  {
    ...
    color: 'Navy Blue, Beige, Charcoal',
    features: [
  ...
  },
  {
    ...
    color: 'Natural Oak, Walnut, Black',
    features: [
  ...
  },
  {
    ...
    color: 'Espresso, White, Natural Wood',
    features: [
